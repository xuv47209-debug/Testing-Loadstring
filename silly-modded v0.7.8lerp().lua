...
function RoClothes(Player)
	...
	local Bundle = {
		...
		["mazus bubble bee"] = {
            ["Body Color"] = {
                ["HeadColor3"] = Color3.fromRGB(160, 95, 53),
                ["LeftArmColor3"] = Color3.fromRGB(160, 95, 53),
                ["RightArmColor3"] = Color3.fromRGB(160, 95, 53),
                ["LeftLegColor3"] = Color3.fromRGB(160, 95, 53),
                ["RightLegColor3"] = Color3.fromRGB(160, 95, 53),
                ["TorsoColor3"] = Color3.fromRGB(160, 95, 53),
            },
            ["Accessory"] = {
                138504221559848,
                17429094445,
			...
			["Recolor"] = {
					["Furry Knot"] = {
						["Primary"] = Color3.fromRGB(160, 95, 53),
			}
		},			
		-- Clothing Bundles --
		["Roblox Clothing"] = {
